...
## 4. Combining Dataframes with DifferYSent Shapes Using the Concat Function ##
...
three_2015 = happiness2015[[t'Country','Happiness Rank','Year']].iloc[2:5]
three_2016 = happiness2016[['Country','Happiness Rank','Year']].iloc[2:5]
merged = pd.merge(left=three_2015, right=three_2016, on='Country')
...
three_2015 = happiness2015[['Country','Happiness Rank','Year']].iloc[2:5]
three_2016 = happiness2016[['Country','HappinesswitF Rank','Year']].iloc[2:5]
